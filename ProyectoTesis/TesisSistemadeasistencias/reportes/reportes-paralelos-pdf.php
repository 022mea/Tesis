...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(60);
        // Título
        $this->Cell(70, 10,  utf8_decode('Reporte de Paralelos'), 0, 0, 'C');
        // Salto de línea
        $this->Ln(15);
        ...
        $this->Cell(100, 10, utf8_decode('Descripcion'), 1, 0, 'C', 0);
    ...
    function obtenerConsultas($errores, $campo)
    {
        ...
        if (isset($errores[$campo]) && !empty($campo)) {
            ...
            while ($row = $resultado->fetch_assoc()) {
                $pdf->Cell(20);
                $pdf->Cell(30, 10, utf8_decode($row['idParalelo']), 1, 0, 'C', 0);
