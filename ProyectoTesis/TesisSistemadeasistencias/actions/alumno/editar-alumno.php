 ...
 if ($_POST) {
    ...
    */
    ...
    if (count($errores) == 0) {
        ...
        $query = "UPDATE tb_alumno SET nombres='$nombres',apellidos='$apellidos',cedula='$cedula',
                edad='$edad', direccion='$direccion' ,telefono='$telefono', correo='$correo', idCurso='$id_curso', idParalelo='$id_paralelo', jornada='$jornada' 
        ...
        header('Location: ../../view/alumno/view.mostrar-alumno.php');
