...
date_default_timezone_set("America/Guayaquil");
 if ($_POST) {
    ...
    */
    ...
    if (count($errores) == 0) {
        $_SESSION['errores'] = 'Usuario Registrado';
        //***************************************************************************************
        ...
        $query = "INSERT INTO tb_usuario(nombre, apellido, correo, password, idTipoUsuario, estado) VALUES('$nombres','$apellidos','$correo','$password','$id_tipo_usuario','$estado')";
        ...
        if ($resultado) {
            ...
            window.location='../../view/usuario/view.crear-usuario.php'</script>";
        }
        ...
        header('Location: ../../view/usuario/view.crear-usuario.php');
