...
<body>
    ...
    <a href="./view.crear-curso.php" class="btn btn-primary mb-1 crear">REGISTRAR CURSO</a>
    ...
    <h4>Listado de cursos registrados</h4>
    <div class="container">
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($mostrar = $result->fetch_assoc()) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action='../../actions/curso/eliminar-curso.php' method='POST'>
                                        <a href='./view.editar-curso.php?idCurso=$idCurso' class='btn btn-info'>Editar</a>
                                        <input type='hidden' value='$idCurso' id='id_curso_eliminar' name='id_curso_eliminar' />
                        ...
                        echo 'Actualmente no existen cursos registrados';
                    }
