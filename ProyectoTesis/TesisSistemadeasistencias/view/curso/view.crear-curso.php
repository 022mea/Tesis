    ...
    <div class="col-xl-10 offset-xl-1">
        <form  name="formulario"  id='loginform' method="POST">
            <div class="divider d-flex align-items-center my-1">
                <h2 class="text-center fw-bold mx-3 mb-0">Registrar Curso</h2>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col">
            ...
            <div class="text-center text-lg-start mt-4 pt-2">
                ...
                <script src="../../js/curso/validar-curso1.js"></script>
        </form>
    </div>
    <script type="text/javascript">
        $(document).ready(function() {
            $('#loginform').submit(function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: '../../actions/curso/crear-curso.php',
                    data: $(this).serialize(),
                    success: function(response) {
                        ...
                        if (jsonData.success == "1") {
                           ...
                           location.href = '../../view/curso/view.mostrar-curso.php';
                        } else {
